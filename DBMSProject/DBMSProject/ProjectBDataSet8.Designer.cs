...
namespace DBMSProject.ProjectBDataSet8TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([RegistrationNumber" +
                "] = @Original_RegistrationNumber))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Student] SET [RegistrationNumber] = @RegistrationNumber WHERE (([Id" +
                "] = @Original_Id) AND ([RegistrationNumber] = @Original_RegistrationNumber));\r\nS" +
                "ELECT Id, RegistrationNumber FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBMSProject.Properties.Settings.Default.ProjectBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, RegistrationNumber FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Id, string Original_RegistrationNumber) {
        ...
        public virtual int Update(string RegistrationNumber, int Original_Id, string Original_RegistrationNumber, int Id) {
            ...
            if ((Original_RegistrationNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_RegistrationNumber));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string RegistrationNumber, int Original_Id, string Original_RegistrationNumber) {
            return this.Update(RegistrationNumber, Original_Id, Original_RegistrationNumber, Original_Id);
        }
    }
